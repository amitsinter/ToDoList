    ...
    /* Event Listeners when the user press on "add" or enter */
    ...
    function addItem(text) 
    {
        ...
        /*create container for the buttons remove complete and edit */
        let buttons = document.createElement('div');
        buttons.classList.add("buttons");

        
        /* Creating the button remove */
        let remove = document.createElement('button');
        remove.classList.add('remove');
        remove.innerHTML = removeSVG;
        remove.addEventListener("click", removeItem);

        /* Creating the button complete */
    ...
    {
        /* targeting the parent (button -> div -> li) */
        let item = this.parentNode.parentNode;

        /* targeting the `ul` (li -> ul)*/
    ...
    /* Clear all the items in "Tasks to do" list and "completed tasks" list */
